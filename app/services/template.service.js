const from = '"Placement Portal" <placementportal@iitk.ac.in>';
const baseUrl = 'http://placements.iitk.ac.in';
const email_signature = '<br><br>With Regards.<br><br>Prof. Mahender Choudhary<br>In-charge, Training & Placement<br>+91-141-2529065';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                subject: 'Login Request : Placement Cell, ',
        ...
        case 'forgotPassword':
            return {
                from: from,
                to: data.college_email,
                subject: 'Reset Password Request : Placement Cell, ',
        ...
        case 'passwordUpdated':
            return {
                from: from,
                to: data.college_email,
                subject: 'Password Updated : Placement Cell, ',
